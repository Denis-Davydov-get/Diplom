...
from .form import CategoryForm, IngredientForm, RecipeForm
...
def add_recipe(request):
    ...
    return render(request, 'recipe/form_add.html', {'form': form, 'message': message})
...
def update_recipe(request, recipe_name):
    ...
    if recipe is not None:
        if recipe.author == request.user:
            ...
            return render(request, 'recipe/form_edit.html', {'form': form,
                                                                'message': message,
                                                                'recipe': recipe})
        else:
            return render(request, 'recipe/404.html',
